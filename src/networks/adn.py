...
from .blocks import ConvolutionBlock, ResidualBlock, FullyConnectedBlock, LayerNorm, SafeInstanceNorm
...
class NLayerDiscriminator(nn.Module):
    ...
    def __init__(self, input_nc, ndf=64, n_layers=3, norm_layer=nn.BatchNorm2d):
        ...
        if type(norm_layer) is str:
            norm_layer = {
                "layer": LayerNorm,          # ZMIANA: Używamy Twojej klasy z blocks.py
                "instance": SafeInstanceNorm, # ZMIANA: Używamy Twojej klasy z blocks.py
