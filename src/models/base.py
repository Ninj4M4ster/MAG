...
class BaseTrain(Base):
    ...
    def _get_trainer(self, model_dict, model_type, opt_type="adam"):
        ...
        # def _update(self, backprop=True, retain_graph=False):
        def _update(self, backprop=True, retain_graph=True, scaler=None):
    ...
    def _setup_learn(self, params, opt_type="adam"):
        ...
        if opt_type == "adam":
            optimizer = optim.Adam(params, lr=self.lr,
                betas=(self.beta1, self.beta2), weight_decay=self.weight_decay, eps=1e-4)
